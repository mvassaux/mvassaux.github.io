...
**highway to predict the stability of a complete nuclear power-plant**: methodology to predict the stability of high-risk reinforced concrete buildings facing earthquakes from rare experimental data.
